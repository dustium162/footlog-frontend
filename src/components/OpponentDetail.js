    ...
    <>
      ...
      <Row className="align-items-end ms-1">
        ...
        <Col xs={7} className="text-end">
          ...
          <div style={{marginTop: "-1rem"}}>勝率：<span style={{fontSize: "2rem"}}>{Math.round(parseFloat(clubMatchResultDetail.home.win)/(clubMatchResultDetail.home.win + clubMatchResultDetail.home.lose + clubMatchResultDetail.home.draw)*100000)/1000}</span><span style={{fontSize: "0.75rem"}}>%</span></div>
        </Col>
        <Col xs={4} className="text-start" style={{marginLeft: "1.25rem"}}>
      ...
      <Row className="align-items-end ms-1">
        ...
        <Col xs={7} className="text-end">
          ...
          <div style={{marginTop: "-1rem"}}>勝率：<span style={{fontSize: "2rem"}}>{Math.round(parseFloat(clubMatchResultDetail.away.win)/(clubMatchResultDetail.away.win + clubMatchResultDetail.away.lose + clubMatchResultDetail.away.draw)*100000)/1000}</span><span style={{fontSize: "0.75rem"}}>%</span></div>
        </Col>
        <Col xs={4} className="text-start" style={{marginLeft: "1.25rem"}}>
